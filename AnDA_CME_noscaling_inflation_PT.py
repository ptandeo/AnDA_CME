...
from AnDA_codes.AnDA_analog_forecasting_with_cov_output import AnDA_analog_forecasting ### MODIFICATION ###
from AnDA_codes.AnDA_model_forecasting import AnDA_model_forecasting
from AnDA_codes.AnDA_data_assimilation_with_adaptive_inflation import AnDA_data_assimilation ### MODIFICATION ###
...
save('tab_ME_AnDA_noscaling_inflation.npy', tab_ME_AnDA)
save('tab_yo_noscaling_inflation.npy', yo.time)
